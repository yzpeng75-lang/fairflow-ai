...
export default function App() {
  ...
  if (!selected) {
    return <main className="lab-shell">
      <header className="lab-header"><div><p className="kicker">FAIRFLOW RESEARCH ENVIRONMENT</p><h1>Checkout Lab</h1><p className="intro">Eight synthetic flows. Four controlled pairs. Three live evidence detectors.</p></div><div className="lab-stamp">DAY 07</div></header>
